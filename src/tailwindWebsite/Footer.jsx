        ...
        <div className='bg-slate-200'>
            <div className='max-w-[1240px] mx-auto py-16 px-4 grid lg:grid-cols-3 gap-8 text-white'>
                <div>
                    ...
                    <div className='flex justify-between w-full md:w-[50%] lg:w-[75%] my-6'>
                ...
                <div className='lg:col-span-2 md:flex justify-between mt-6 text-slate-700'>
                    <div className='h-[200px] w-full sm:w-1/2 flex justify-between md:justify-around'>
                        <div>
